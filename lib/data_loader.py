...
class Data:
    ...
    def get_data_per_server(self, server_id, default={"user": {}, "item": {}}):
        if not self.data.get(str(server_id)):
            self.data[str(server_id)] = default
        return self.data[str(server_id)]

    def get_data_per_user(self, user_id, default={"user": {}, "item": {}}):
    ...
    def get_data(self, interaction, default={"user": {}, "item": {}}):
